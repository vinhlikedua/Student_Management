        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" method="post"
                    action="index.php?c=department&m=handle-edit&id=<?= $info['id']; ?>">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <?php endif; ?>
                                <br />
                                <img width="50%" class="img-fluid" alt="<?= $info['name']; ?>"
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input value="<?= $info['date_beginning']; ?>" type="date" class="form-control"
                                    name="beginning_date" />
                            </div>
